...
func FunctionSpecs(typeAliases map[string]ast.Type) []FunctionSpec {
	raw := []FunctionSpec{
		...
		spec("__std_sb_new", ast.TypeString),
		spec("__std_sb_append", ast.TypeString, ast.TypeString, ast.TypeString),
		spec("__std_sb_string", ast.TypeString, ast.TypeString),
		spec("__std_sb_len", ast.TypeInt, ast.TypeString),
		spec("__std_sb_clear", ast.TypeString, ast.TypeString),
